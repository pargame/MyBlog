...
### **1. 주요 역할 및 책임**
* **텍스트 블록 외형 정의:**
    [[UTextBlock]]의 모든 시각적 요소를 한 곳에서 정의하여 일관된 스타일을 적용할 수 있게 합니다.
...
2.  드롭다운 메뉴에서 [[USlateWidgetStyleAsset]]을 선택하거나, 구조체를 직접 펼쳐 `FTextBlockStyle`의 각 속성(`Font`, `ColorAndOpacity` 등)을 개별적으로 설정합니다.
