...
1. **컴포넌트 추가:** [[AActor]]의 블루프린트에서 `Mesh Component`를 추가합니다.
2. **메시 및 머티리얼 설정:** `StaticMesh`와 `Material` 속성을 설정합니다.
3. **물리 시뮬레이션 활성화:** `bSimulatePhysics`를 활성화하여 물리적 상호작용을 설정합니다.
