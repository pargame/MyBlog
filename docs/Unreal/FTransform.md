...
### **4. 사용 방법·패턴**
*   [[AActor]]의 월드 트랜스폼 얻기: `GetActorTransform()`은 루트 컴포넌트의 월드 `FTransform`을 반환합니다.
*   컴포넌트 부착: `AttachToComponent` 시 자식은 부모 기준의 Relative `FTransform`을 가집니다.
*   좌표 변환: `GetActorTransform().TransformPosition(FVector(100,0,0))`처럼 로컬 → 월드 변환을 수행합니다.

### **5. 관련 구조체**
*   **[[FVector]]:** 이동과 크기를 나타냅니다.
*   **[[FQuat]]:** 회전을 나타냅니다.
*   **[[FRotator]]:** 에디터 편집용 회전 표현으로, 내부적으로 [[FQuat]]와 상호 변환됩니다.
