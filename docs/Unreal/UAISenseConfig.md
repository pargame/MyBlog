...
### **2. 주요 서브클래스**
> 언리얼 엔진은 기본적인 감각들에 대한 설정 클래스를 미리 제공합니다.
...
4.  추가된 항목을 펼쳐, 원하는 감각 설정 클래스(예: `AISense_Sight_Config`)를 선택하고 세부 속성을 조절합니다.

### **4. 관련 클래스**
* **[[UAIPerceptionComponent]]:**
    이 설정 클래스들을 사용하여 실제로 감각을 처리하고 [[Event]]를 발생시키는 주체입니다.
* **`UAISense`:**
