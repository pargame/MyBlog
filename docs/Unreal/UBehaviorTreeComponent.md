...
* **블랙보드 연동 (Interfacing with Blackboard):**
    자신과 쌍을 이루는 [[UBlackboardComponent]]에 접근하여 데이터를 읽고 쓰는 인터페이스를 제공합니다. 비헤이비어 트리의 노드들은 이 컴포넌트를 통해 블랙보드와 상호작용합니다.
...
* **[[UBlackboardComponent]]:**
    AI의 메모리 역할을 하며, 이 컴포넌트와 긴밀하게 연동하여 작동합니다.
* **[[UBTNode]]:**
    비헤이비어 트리를 구성하는 모든 노드(Task, Decorator, Service)의 기본 클래스로, 이 컴포넌트에 의해 실행됩니다.
