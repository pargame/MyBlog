...
*   **데코레이터:** 이 복합 노드 전체의 실행 여부를 결정하는 조건을 추가합니다.
*   **서비스:** 이 복합 노드의 자식들이 실행되는 동안, 주기적으로 실행될 로직을 추가합니다.

### **4. 관련 클래스**
*   **[[UBTNode]]:** 모든 비헤이비어 트리 노드의 부모 클래스입니다.
*   **[[UBTTaskNode]]:** 복합 노드에 의해 실행되는 실제 '행동' 노드입니다.
*   **[[UBTDecorator]]:** 복합 노드나 그 자식들의 실행을 제어하는 '조건문'입니다.
*   **[[UBTService]]:** 복합 노드가 활성화된 동안 실행되는 '서비스'입니다.
